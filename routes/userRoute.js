...
Route.get('/postjob',UserController.auth2,UserController.postjob);
Route.post('/postcreate',UserController.postcreate)
Route.get('/about',UserController.about);
Route.get('/contact',UserController.contact)
Route.get('/logout',UserController.logout);
Route.get('/register_emp',UserController.register_emp)
Route.get('/viewjob/:id',UserController.auth2,UserController.view_job)
...
// Contact
Route.post('/contactcreate',UserController.auth2,UserController.contactcreate);
//...category
...
//....apply
Route.get('/apply/:id',UserController.auth2,UserController.apply)

//...applied jobs
Route.get('/appliedjobs',UserController.auth2,UserController.appliedjobs)
...
//...profile
Route.get('/profile',UserController.auth2,UserController.profile)
